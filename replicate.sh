...
python3 ./conv_split_cifar.py --train-single-epoch --mem-size 1 --arch $ARCH --random-seed 1234 --num-runs $NUM_RUNS --batch-size $BATCH_SIZE --optim $OPTIM --learning-rate $lr --imp-method $imp_method --synap-stgth 0.0 --log-dir $LOG_DIR
python3 ./conv_split_cifar.py --train-single-epoch --mem-size 1 --arch $ARCH --random-seed 7295 --num-runs $NUM_RUNS --batch-size $BATCH_SIZE --optim $OPTIM --learning-rate $lr --imp-method $imp_method --synap-stgth 0.0 --log-dir $LOG_DIR
python3 ./conv_split_cifar.py --train-single-epoch --mem-size 1 --arch $ARCH --random-seed 5234 --num-runs $NUM_RUNS --batch-size $BATCH_SIZE --optim $OPTIM --learning-rate $lr --imp-method $imp_method --synap-stgth 0.0 --log-dir $LOG_DIR
...
python3 ./conv_split_cifar.py --train-single-epoch --mem-size 1 --arch $ARCH --random-seed 5234 --num-runs $NUM_RUNS --batch-size $BATCH_SIZE --optim $OPTIM --learning-rate $lr --imp-method VAN --synap-stgth 0.0 --log-dir $LOG_DIR